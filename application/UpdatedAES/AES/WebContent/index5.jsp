      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li><a href="citySalvado.jsp">Salvador Benedicto</a></li>
              _______________________________
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Region: CAR</h2>
          <div class="table-responsive">
            <table class="table table-striped" id="query">
              ...
              <%
				...
				ResultSet regionNCRduterte = stat.executeQuery("SELECT DISTINCT candidacy,name,vote FROM tapat where region='CAR';");
