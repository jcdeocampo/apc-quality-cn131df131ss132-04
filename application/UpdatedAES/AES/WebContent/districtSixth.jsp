    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Region: XVIII &raquo; Province: Negros Occidental &raquo; District: Sixth</h2>
          <div class="table-responsive">
            <table class="table table-striped" id="query">
              ...
              <%
				...
				ResultSet regionNCRduterte = stat.executeQuery("SELECT DISTINCT candidacy,name,vote FROM tapat where region='XVIII' and province='Negros Occidental' and district='Sixth District';");
